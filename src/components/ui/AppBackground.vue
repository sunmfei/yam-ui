...
import ParticlesBg from './bg/ParticlesBg.vue'
import GradientBg from './bg/GradientBg.vue'
import GridBg from './bg/GridBg.vue'
import WaveBg from './bg/WaveBg.vue'
import NatureBg from './bg/NatureBg.vue'
