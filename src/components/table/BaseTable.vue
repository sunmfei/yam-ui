<template>
  <!-- 背景容器 - 始终全屏 -->
  <div
    class="h-screen w-full overflow-hidden bg-gradient-to-br from-background via-background to-muted/20 p-6"
  >
    <!-- 内容容器 - 可配置宽高，带阴影 -->
    <div
      class="mx-auto flex h-full flex-col space-y-6 overflow-hidden rounded-3xl border border-border/50 bg-card shadow-2xl backdrop-blur-sm"
      :class="props.width"
    >
      <!-- 头部区域 -->
      <section
        v-if="showHeader"
        class="relative overflow-hidden rounded-t-3xl border-b border-border/50 bg-card px-6 py-4"
      >
      ...
      <!-- 表格区域 + 配置面板 -->
      <section class="flex-1 overflow-hidden bg-card">
        <div
          ...
          >
            ...
            <div class="space-y-3">
              ...
              >
                ...
                <Switch v-model="localTreeEnabled" class="data-[state=checked]:bg-primary" />
              </div>
              ...
              >
                ...
                <Switch v-model="localDefaultExpandAll" class="data-[state=checked]:bg-primary" />
              </div>
              ...
              >
                ...
                <Switch v-model="localExpandOnRowClick" class="data-[state=checked]:bg-primary" />
              </div>
              ...
              >
                <div>
                  <div class="text-sm font-semibold">启用多选</div>
                  <div class="mt-1 text-xs text-muted-foreground">显示复选框列</div>
                </div>
                <Switch v-model="localSelectionEnabled" class="data-[state=checked]:bg-primary" />
              </div>
              ...
              >
                ...
                <Switch v-model="localCheckStrictly" class="data-[state=checked]:bg-primary" />
              </div>
              ...
              >
                ...
                <Switch v-model="localPaginationEnabled" class="data-[state=checked]:bg-primary" />
              </div>
