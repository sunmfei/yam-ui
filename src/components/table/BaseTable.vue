      ...
      <div class="relative flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between">
        <div class="space-y-4">
          <div>
            ...
            <p v-if="subtitle" class="mt-3 max-w-3xl text-sm leading-relaxed text-muted-foreground">
              {{ subtitle }}
            </p>
          </div>
        </div>
...
// 事件处理
// =============================================
function handleSelectionChange(rows: unknown[], keys: Array<string | number>) {
