...
import AppSidebar from '@/components/blocks/sidebar-10/components/AppSidebar.vue'
import NavActions from '@/components/blocks/sidebar-10/components/NavActions.vue'
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbList,
