...
import SidebarLeft from '@/components/blocks/sidebar-15/components/SidebarLeft.vue'
import SidebarRight from '@/components/blocks/sidebar-15/components/SidebarRight.vue'
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbList,
