...
import SearchForm from '@/components/blocks/sidebar-02/components/SearchForm.vue'
import VersionSwitcher from '@/components/blocks/sidebar-02/components/VersionSwitcher.vue'
